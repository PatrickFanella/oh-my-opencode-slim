...
const outputPath = join(rootDir, 'blacktower.schema.json');
...
const jsonSchema = {
  ...
  title: 'blacktower',
  description: 'Configuration schema for blacktower plugin for OpenCode',
};
...
const customAgentJsonSchema = {
  ...customAgentSchema,
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  title: 'blacktower custom agent definition',
  description:
    'Schema for JSON custom agents loaded from blacktower/agents/*.json',
};
