...
const packagedRequiredFiles = [
  ...
  'src/skills/agent-ecosystem/customize-opencode/SKILL.md',
  'src/skills/dev-workflows/codemap/SKILL.md',
  'src/skills/dev-workflows/clonedeps/SKILL.md',
  'src/skills/quality-review/simplify/SKILL.md',
