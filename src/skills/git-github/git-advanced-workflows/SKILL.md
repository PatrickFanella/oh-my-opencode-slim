...
- `references/curated/finishing-a-development-branch.md` — Finishing A Development Branch guidance.
- `references/curated/monorepo-management.md` — Monorepo Management guidance.
- `references/curated/using-git-worktrees.md` — Using Git Worktrees guidance.
