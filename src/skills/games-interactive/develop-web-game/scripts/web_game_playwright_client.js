...
// Usage: node web_game_playwright_client.js --url http://localhost:3000 [--iterations 3]
// Side effects: opens a Playwright Chromium session and writes screenshots plus
// observation JSON to --screenshot-dir (default: output/web-game).
