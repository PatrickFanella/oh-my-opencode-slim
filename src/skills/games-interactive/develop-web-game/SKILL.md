...
- `references/`
  - `references/action_payloads.json` — focused reference material for deeper lookup.
- `scripts/`
  - `scripts/web_game_playwright_client.js` — deterministic helper script or script support file.
- `assets/`
  - `assets/game-small.svg` — static asset used by the skill.
  - `assets/game.png` — static asset used by the skill.
