"""Unit tests for cartographer.py.

Usage:
    python3 -m unittest skills/dev-workflows/cartography/scripts/test_cartographer.py

Side effects:
    Creates temporary files/directories only through tempfile and removes them
    during test cleanup.
"""
