...
- create and maintain a local markdown progress file under `.blacktower/deepwork/`;
...
```text
.blacktower/deepwork/<short-task-slug>.md
```

Keep `.blacktower/deepwork/` out of git, but make it readable to OpenCode. Ensure the
