...
- [parallel-feature-development](../../dev-workflows/parallel-feature-development/SKILL.md) — Decompose work streams and assign file ownership once the team is composed
...
- `references/`
  - `references/agent-type-selection.md` — focused reference material for deeper lookup.
  - `references/preset-teams.md` — focused reference material for deeper lookup.
