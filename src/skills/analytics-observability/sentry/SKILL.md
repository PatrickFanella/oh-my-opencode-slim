...
- `scripts/`
  - `scripts/sentry_api.py` — deterministic helper script or script support file.
- `assets/`
  - `assets/sentry-small.svg` — static asset used by the skill.
  - `assets/sentry.png` — static asset used by the skill.
