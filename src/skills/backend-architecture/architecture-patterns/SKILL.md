...
- `references/`
  - `references/advanced-patterns.md` — focused reference material for deeper lookup.
...
- `references/curated/architecture-decision-records.md` — Architecture Decision Records guidance.
- `references/curated/microservices-patterns.md` — Microservices Patterns guidance.
