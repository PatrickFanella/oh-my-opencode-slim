...
- `references/`
  - `references/alternatives.md` — focused reference material for deeper lookup.
  - `references/patterns.md` — focused reference material for deeper lookup.
  - `references/protocol.md` — focused reference material for deeper lookup.
  - `references/scaling.md` — focused reference material for deeper lookup.
  - `references/security.md` — focused reference material for deeper lookup.
