...
- `references/`
  - `references/metadata-and-api-map.md` — focused reference material for deeper lookup.
  - `references/scriptcat-extensions.md` — focused reference material for deeper lookup.
