---
name: cli-developer
description: Use when building CLI tools, implementing argument parsing, or adding interactive prompts. Invoke for parsing flags and subcommands, displaying progress bars and spinners, generating bash/zsh/fish completion scripts, CLI design, shell completions, and cross-platform terminal applications using Rust clap, Go Cobra, or TypeScript Commander.
license: MIT
metadata:
  author: https://github.com/Jeffallan
  version: "1.1.0"
  domain: devops
  triggers: CLI, command-line, terminal app, argument parsing, shell completion, interactive prompt, progress bar, clap, cobra, commander
  role: specialist
...
| Rust CLIs | `references/rust-cli.md` | clap, cargo-dist, inquire, indicatif |
| Go CLIs | `references/go-cli.md` | cobra, viper, bubbletea |
| TypeScript CLIs | `references/node-cli.md` | commander, yargs, inquirer, chalk |
| Python CLIs | `references/python-cli.md` | only when Python is driving a tool/doc generator |
...
For Rust (clap), Go (cobra), and Python tool-only examples, see references.

## Constraints

### MUST DO
- Prefer Rust, Go, or TypeScript. Use Python only for internal automation/doc/data tools.
...
CLI frameworks (clap, cobra, commander; Python argparse/typer only for tool scripts), terminal UI (chalk, inquirer, rich, bubbletea), testing (snapshot testing, E2E), distribution (npm, pip, homebrew, releases), performance optimization

## Resources

- `references/`
  - `references/rust-cli.md` — focused reference material for Rust CLI defaults.
  - `references/design-patterns.md` — focused reference material for deeper lookup.
  - `references/go-cli.md` — focused reference material for deeper lookup.
  - `references/node-cli.md` — focused reference material for deeper lookup.
  - `references/python-cli.md` — focused reference material for deeper lookup.
  - `references/ux-patterns.md` — focused reference material for deeper lookup.
