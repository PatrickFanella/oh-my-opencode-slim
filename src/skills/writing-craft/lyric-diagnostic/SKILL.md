...
- `scripts/`
  - `scripts/cliche-check.ts` — deterministic helper script or script support file.
  - `scripts/meter-check.ts` — deterministic helper script or script support file.
  - `scripts/rhyme-check.ts` — deterministic helper script or script support file.
