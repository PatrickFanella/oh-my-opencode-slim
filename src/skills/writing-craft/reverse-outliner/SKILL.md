...
- `scripts/`
  - `scripts/analyze-scene-batch.ts` — deterministic helper script or script support file.
  - `scripts/detect-genre.ts` — deterministic helper script or script support file.
  - `scripts/generate-outline.ts` — deterministic helper script or script support file.
  - `scripts/reverse-outline.ts` — deterministic helper script or script support file.
  - `scripts/segment-book.ts` — deterministic helper script or script support file.
  - `scripts/track-characters.ts` — deterministic helper script or script support file.
