...
- `scripts/`
  - `scripts/genre-blend.ts` — deterministic helper script or script support file.
  - `scripts/genre-check.ts` — deterministic helper script or script support file.
  - `scripts/genre-elements.ts` — deterministic helper script or script support file.
