...
- `scripts/`
  - `scripts/representation-map.ts` — deterministic helper script or script support file.
  - `scripts/sensitivity-audit.ts` — deterministic helper script or script support file.
