...
- `scripts/`
  - `scripts/score-scene.ts` — deterministic helper script or script support file.
- `templates/`
  - `templates/pass-criteria.md` — reusable output or tracking template.
  - `templates/progress-tracker.md` — reusable output or tracking template.
