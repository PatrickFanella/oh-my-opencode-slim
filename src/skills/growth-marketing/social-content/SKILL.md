...
- `references/`
  - `references/platform-limits.md` — focused reference material for deeper lookup.
  - `references/platforms.md` — focused reference material for deeper lookup.
  - `references/post-templates.md` — focused reference material for deeper lookup.
  - `references/reverse-engineering.md` — focused reference material for deeper lookup.
  - `references/short-form-video.md` — focused reference material for deeper lookup.
