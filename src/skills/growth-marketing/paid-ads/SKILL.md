...
- `references/`
  - `references/ad-copy-templates.md` — focused reference material for deeper lookup.
  - `references/audience-targeting.md` — focused reference material for deeper lookup.
  - `references/conversion-tracking.md` — focused reference material for deeper lookup.
  - `references/platform-setup-checklists.md` — focused reference material for deeper lookup.
...
- `references/curated/ad-creative.md` — Ad Creative guidance.
