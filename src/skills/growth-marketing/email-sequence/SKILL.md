...
- `references/`
  - `references/copy-guidelines.md` — focused reference material for deeper lookup.
  - `references/email-types.md` — focused reference material for deeper lookup.
  - `references/sequence-templates.md` — focused reference material for deeper lookup.
...
- `references/curated/cold-email.md` — Cold Email guidance.
