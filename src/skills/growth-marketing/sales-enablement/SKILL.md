...
- `references/`
  - `references/deck-frameworks.md` — focused reference material for deeper lookup.
  - `references/demo-scripts.md` — focused reference material for deeper lookup.
  - `references/objection-library.md` — focused reference material for deeper lookup.
  - `references/one-pager-templates.md` — focused reference material for deeper lookup.
