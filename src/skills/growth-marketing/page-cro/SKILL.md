...
- `references/`
  - `references/experiments.md` — focused reference material for deeper lookup.
...
- `references/curated/form-cro.md` — Form Cro guidance.
- `references/curated/onboarding-cro.md` — Onboarding Cro guidance.
- `references/curated/paywall-upgrade-cro.md` — Paywall Upgrade Cro guidance.
- `references/curated/popup-cro.md` — Popup Cro guidance.
- `references/curated/signup-flow-cro.md` — Signup Flow Cro guidance.
