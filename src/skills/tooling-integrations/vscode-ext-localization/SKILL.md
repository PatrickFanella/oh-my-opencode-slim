...
> **See also:** `vscode-ext-commands` (contributing and configuring VS Code extension commands).
...
- Add support for a new language to your extension
- Verify that all user-facing strings are properly localized
