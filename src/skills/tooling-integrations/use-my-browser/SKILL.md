...
- `references/`
  - `references/anti-automation-friction.md` — focused reference material for deeper lookup.
  - `references/browser-capability-matrix.md` — focused reference material for deeper lookup.
  - `references/browser-playbook.md` — focused reference material for deeper lookup.
  - `references/browser-recovery.md` — focused reference material for deeper lookup.
  - `references/control-plane-workflows.md` — focused reference material for deeper lookup.
  - `references/debug-handoff.md` — focused reference material for deeper lookup.
  - `references/deep-dom.md` — focused reference material for deeper lookup.
  - `references/media-inspection.md` — focused reference material for deeper lookup.
  - `references/parallel-browser-ownership.md` — focused reference material for deeper lookup.
  - plus 3 more files in `references/`.
...
- `references/curated/chrome-devtools.md` — Chrome Devtools guidance.
