...
> **See also:** `vscode-ext-localization` (localizing VS Code extension strings and resources).
...
- Define command visibility, enablement, and positioning
- Follow VS Code naming conventions for commands
