 ...
 *
 * Usage:
 *   deno run --allow-run --allow-env --allow-read protocol_smoke.ts --command ./scripts/run-mcp.sh --timeout-ms 6000
 *
 * Side effects:
 *   Starts the provided MCP command as a child process, sends initialize, then
 *   terminates the process after the smoke check.
 */
