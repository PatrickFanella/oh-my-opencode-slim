...
- `scripts/`
  - `scripts/ensure_macos_permissions.sh` — deterministic helper script or script support file.
  - `scripts/macos_display_info.swift` — deterministic helper script or script support file.
  - `scripts/macos_permissions.swift` — deterministic helper script or script support file.
  - `scripts/macos_window_info.swift` — deterministic helper script or script support file.
  - `scripts/take_screenshot.ps1` — deterministic helper script or script support file.
  - `scripts/take_screenshot.py` — deterministic helper script or script support file.
- `assets/`
  - `assets/screenshot-small.svg` — static asset used by the skill.
  - `assets/screenshot.png` — static asset used by the skill.
