#!/usr/bin/env bash
# Usage: ./ensure_macos_permissions.sh
# Side effects: checks macOS Screen Recording permission and may trigger the
# system permission prompt when permission is missing.
set -euo pipefail
