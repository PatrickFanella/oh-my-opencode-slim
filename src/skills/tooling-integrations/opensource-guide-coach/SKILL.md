...
- `references/`
  - `references/attribution.md` — focused reference material for deeper lookup.
  - `references/guide-map.md` — focused reference material for deeper lookup.
  - `references/persona-router.md` — focused reference material for deeper lookup.
