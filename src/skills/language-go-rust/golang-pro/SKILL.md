...
- `references/`
  - `references/concurrency.md` — focused reference material for deeper lookup.
  - `references/generics.md` — focused reference material for deeper lookup.
  - `references/interfaces.md` — focused reference material for deeper lookup.
  - `references/project-structure.md` — focused reference material for deeper lookup.
  - `references/testing.md` — focused reference material for deeper lookup.
...
- `references/curated/go-concurrency-patterns.md` — Go Concurrency Patterns guidance.
