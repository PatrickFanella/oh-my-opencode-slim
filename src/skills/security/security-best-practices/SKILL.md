...
- `references/`
  - `references/golang-general-backend-security.md` — focused reference material for deeper lookup.
  - `references/javascript-express-web-server-security.md` — focused reference material for deeper lookup.
  - `references/javascript-general-web-frontend-security.md` — focused reference material for deeper lookup.
  - `references/javascript-jquery-web-frontend-security.md` — focused reference material for deeper lookup.
  - `references/javascript-typescript-nextjs-web-server-security.md` — focused reference material for deeper lookup.
  - `references/javascript-typescript-react-web-frontend-security.md` — focused reference material for deeper lookup.
  - `references/javascript-typescript-vue-web-frontend-security.md` — focused reference material for deeper lookup.
  - `references/python-django-web-server-security.md` — focused reference material for deeper lookup.
  - `references/python-fastapi-web-server-security.md` — focused reference material for deeper lookup.
  - `references/python-flask-web-server-security.md` — focused reference material for deeper lookup.
