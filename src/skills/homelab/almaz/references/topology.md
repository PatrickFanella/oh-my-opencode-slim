...
Last verified from live state and docs pass: 2026-05-18. Refresh live state before critical operations.
...
- Kernel baseline after upgrade: `7.0.0-15-generic`
- Hardware: ASUS Z170-A desktop/server, x86_64, NVIDIA GeForce GTX 1080
- NVIDIA: driver `580.142`, CUDA `13.0` observed working after upgrade
