...
- `references/`
  - `references/examples/openpyxl/create_basic_spreadsheet.py` — focused reference material for deeper lookup.
  - `references/examples/openpyxl/create_spreadsheet_with_styling.py` — focused reference material for deeper lookup.
  - `references/examples/openpyxl/read_existing_spreadsheet.py` — focused reference material for deeper lookup.
  - `references/examples/openpyxl/styling_spreadsheet.py` — focused reference material for deeper lookup.
- `assets/`
  - `assets/spreadsheet-small.svg` — static asset used by the skill.
  - `assets/spreadsheet.png` — static asset used by the skill.
...
- `references/curated/xlsx-generator.md` — Xlsx Generator guidance.
