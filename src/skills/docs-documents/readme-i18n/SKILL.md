...
- `references/`
  - `references/language-selector-reference.md` — focused reference material for deeper lookup.
  - `references/preservation-checklist.md` — focused reference material for deeper lookup.
