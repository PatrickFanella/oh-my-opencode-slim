...
- `references/`
- `scripts/`
  - `scripts/render_docx.py` — deterministic helper script or script support file.
- `assets/`
  - `assets/doc-small.svg` — static asset used by the skill.
  - `assets/doc.png` — static asset used by the skill.
...
- `references/curated/docx-generator.md` — Docx Generator guidance.
