...
Usage:
    Import `search(query, domain=None)` or `search_stack(query, stack)` from
    skill helpers; this module is not a standalone CLI.

Side effects:
    Reads CSV data under the sibling data/ directory. Does not write files or
