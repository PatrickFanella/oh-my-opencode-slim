...
- improve their Blacktower setup based on actual usage using Blacktower skill;
...
2. Project-local guidance and memories, such as `AGENTS.md`, `.opencode/`,
   `.blacktower/`, notes, checkpoints, task progress files, and codemaps.
3. Existing skills, commands, agents, prompt overrides, MCP permissions, and
   Blacktower configuration.
...
- active Blacktower preset, model routing, skills, and MCP permissions;
