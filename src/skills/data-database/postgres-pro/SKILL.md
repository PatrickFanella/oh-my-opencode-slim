...
- `references/`
  - `references/extensions.md` — focused reference material for deeper lookup.
  - `references/jsonb.md` — focused reference material for deeper lookup.
  - `references/maintenance.md` — focused reference material for deeper lookup.
  - `references/performance.md` — focused reference material for deeper lookup.
  - `references/replication.md` — focused reference material for deeper lookup.
...
- `references/curated/postgresql-table-design.md` — Postgresql Table Design guidance.
- `references/curated/sql-optimization-patterns.md` — Sql Optimization Patterns guidance.
