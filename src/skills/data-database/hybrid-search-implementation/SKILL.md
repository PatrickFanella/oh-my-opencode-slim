...
- `references/curated/embedding-strategies.md` — Embedding Strategies guidance.
- `references/curated/similarity-search-patterns.md` — Similarity Search Patterns guidance.
- `references/curated/vector-index-tuning.md` — Vector Index Tuning guidance.
