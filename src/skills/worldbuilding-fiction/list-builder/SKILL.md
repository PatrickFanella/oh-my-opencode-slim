...
- `references/`
  - `references/dataset-quality-criteria.md` — focused reference material for deeper lookup.
- `scripts/`
  - `scripts/validate-list.ts` — deterministic helper script or script support file.
