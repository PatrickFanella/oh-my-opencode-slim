...
- `scripts/`
  - `scripts/add-entry.ts` — deterministic helper script or script support file.
  - `scripts/build-index.ts` — deterministic helper script or script support file.
  - `scripts/check-conflicts.ts` — deterministic helper script or script support file.
  - `scripts/init-world.ts` — deterministic helper script or script support file.
- `templates/`
  - `templates/discovery.md` — reusable output or tracking template.
  - `templates/entry.md` — reusable output or tracking template.
  - `templates/index.md` — reusable output or tracking template.
  - `templates/style-guide.md` — reusable output or tracking template.
