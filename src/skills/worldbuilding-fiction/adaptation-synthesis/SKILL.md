...
- `references/`
- `scripts/`
  - `scripts/form-options.ts` — deterministic helper script or script support file.
  - `scripts/synthesize.ts` — deterministic helper script or script support file.
  - `scripts/validate-synthesis.ts` — deterministic helper script or script support file.
...
- `references/curated/media-adaptation.md` — Media Adaptation guidance.
- `references/curated/media-meta-analysis.md` — Media Meta Analysis guidance.
