#!/bin/bash
# Usage: ./validate-chart.sh [chart-directory]
# Side effects: runs Helm validation commands and renders templates; does not
# install, upgrade, or mutate a Kubernetes cluster.
set -e
