...
`openai` is the default hybrid provider. It is mostly OpenAI, with only a few
OpenRouter MiniMax assignments for design/creative/product-advisory roles where
model variety is useful.
